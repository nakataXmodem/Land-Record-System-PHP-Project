...
<tr>
    <th>Photo</th>
    <td><img src="admin/firstpartypic/<?php echo $row['fpartypic'];?>" width="150" height="100" value="<?php  echo $row['fpartypic'];?>"></td>
    <th>Photo</th>
    <td><img src="admin/secpartypic/<?php echo $row['secpartypic'];?>" width="150" height="100" value="<?php  echo $row['secpartypic'];?>"></td>
</tr>
